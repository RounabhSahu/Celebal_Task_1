        ...
        <div className='banner'>
            ...
            <div className='banner-container'>
                ...
                <div className='banner-mail-input-button-container'>
                    <input contentEditable='true' className='banner-mail-input' type='email' placeholder='Mail bültenimize kayıt ol' value={text} onChange={(e)=>setText(e.target.value)}/>
                    <button className='banner-mail-input-button'>Kayıt Ol</button>
